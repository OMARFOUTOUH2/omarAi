...
// 
// Select the container and all sections
const sectionsContainer = document.querySelector('.sections4');
const sections = sectionsContainer.querySelectorAll('.section4');

// Select the "Previous" and "Next" buttons
const previo = document.getElementById('previo');
const nextio = document.getElementById('nextio');

// Set the current section index to 0
